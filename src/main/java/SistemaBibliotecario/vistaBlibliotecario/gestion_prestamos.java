 ...
 * @author User
 */
public class gestion_prestamos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jBRegistrarNPrestamo = new javax.swing.JButton();
        ...
        jLabel7.setText("GESTIÓN DE PRESTAMOS");
        ...
        jBRegistrarDevolucion.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jBRegistrarDevolucion.setForeground(new java.awt.Color(19, 38, 76));
        jBRegistrarDevolucion.setText("+ Registrar Devolución");
        jPanel1.add(jBRegistrarDevolucion, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 160, -1, -1));

        jBRegistrarNPrestamo.setBackground(new java.awt.Color(19, 38, 76));
        jBRegistrarNPrestamo.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jBRegistrarNPrestamo.setForeground(new java.awt.Color(255, 255, 255));
        jBRegistrarNPrestamo.setText("+ Registrar Nuevo Prestamo");
        jPanel1.add(jBRegistrarNPrestamo, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, -1, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pendiente", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 210, -1, -1));

        jLabel3.setText("Estado");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 210, -1, -1));
    ...
    private javax.swing.JButton jBRegistrarNPrestamo;
