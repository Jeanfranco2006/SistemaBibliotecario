...
public class ReporteDAO {
    ...
    public List<Prestamo> obtenerPrestamosPorFechaYBibliotecario(Date fechaDesde, Date fechaHasta,
    ...
    public boolean generarReportePrestamosExcel(Date fechaDesde, Date fechaHasta, String dniBibliotecario,
            String rutaArchivo) {
        try {
            ...
            String[] headers = { "ID", "DNI Lector", "Nombres Lector", "Libro", "ISBN", "Fecha Préstamo",
    ...
    public boolean generarReportePrestamosExcelTotal(Date fechaDesde, Date fechaHasta, String estado,
            String rutaArchivo) {
        try {
    ...
    public boolean generarReporteLibrosExcel(Date fechaDesde, Date fechaHasta, boolean esPopular, String categoria,
            String rutaArchivo) {
        try {
            List<Object[]> libros;
            String tipoReporte;
    ...
    // Método para obtener estadísticas de préstamos por usuario (solo lectores
    // pueden tener préstamos)
    ...
    public boolean generarReporteUsuariosExcel(Date fechaDesde, Date fechaHasta, int tipoReporte, String rolFiltro,
            String rutaArchivo) {
        try {
            ...
            switch (tipoReporte) {
                case 1: // Todos los usuarios registrados
                    ...
                    headers = new String[] { "DNI", "Nombre", "Apellidos", "Email", "Teléfono", "Rol", "Fecha Registro",
                ...
                case 2: // Estadísticas de préstamos (solo lectores)
                    ...
                    headers = new String[] { "DNI", "Nombre Completo", "Email", "Rol", "Total Préstamos", "Devueltos",
                            "Activos", "Vencidos", "Último Préstamo", "Estado" };
                    break;
                default:
